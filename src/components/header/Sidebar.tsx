    ...
    <div className="h-screen w-full max-w-screen py-3 px-3 overflow-y-auto overflow-x-hidden bg-[#212529]">
      <div className="flex items-center flex-col h-full">
        ...
        <div className="intro text-center mt-3 mb-2">
          <h3 className="text-3xl text-primary underline mb-1"> Suronjit Pal </h3>
        ...
        <div className={`mt-3 flex justify-between`}>
          <div className={`${styles.icon} ${styles.facebook}`}>
            <a href="https://www.facebook.com/suronjit797/" target="_blank" className="!text-white">
              <FaFacebookF />
            </a>
          </div>
          <div className={`${styles.icon} ${styles.linkedin}`}>
            <a href="https://www.linkedin.com/in/suronjit797/" target="_blank" className="!text-white">
              <FaLinkedinIn />
            </a>
          </div>
          <div className={`${styles.icon} ${styles.gmail}`}>
            <a href="mailto:suronjit797@gmail.com" target="_blank" className="!text-white">
              <BiLogoGmail />
            </a>
          </div>
          <div className={`${styles.icon} ${styles.github}`}>
            <a href="https://github.com/suronjit797" target="_blank" className="!text-white">
              <FaGithub />
            </a>
          </div>
        </div>
